...
namespace IBatisNet.DataMapper
{
    ...
    public class SqlMapper : ISqlMapper
    {
        ...
        {
            get { return this._sessionStore.LocalSession; }
        }
        ...
        {
            get { return (this._sessionStore.LocalSession != null); }
        }
        ...
        {
            get { return this._dbHelperParameterCache; }
        }
        ...
        {
            get { return this._dataExchangeFactory; }
        }
        ...
        {
            get { return this._typeHandlerFactory; }
        }
        ...
        {
            get { return this._objectFactory; }
        }
        ...
        {
            get { return this._accessorFactory; }
        }
        ...
        {
            set { this._cacheModelsEnabled = value; }
            get { return this._cacheModelsEnabled; }
        }
        ...
        public void CloseConnection()
        {
            ...
            try
            {
                ISqlMapSession session = this._sessionStore.LocalSession;
        ...
        public ISqlMapSession BeginTransaction(bool openConnection)
        {
            ...
            {
                session = this._sessionStore.LocalSession;
                if (session == null)
                {
        ...
        public object QueryForObject(string statementName, object parameterObject)
        {
            ...
            if (session == null)
            {
                session = this.CreateSqlMapSession();
                isSessionLocal = true;
            }

            try
            {
                IMappedStatement statement = this.GetMappedStatement(statementName);
        ...
        {
            if (this._mappedStatements.Contains(id) == false)
            {
        ...
        {
            get { return this._mappedStatements; }
        }
        ...
        {
            if (this._parameterMaps.Contains(parameterMap.Id) == true)
            {
        ...
        {
            if (this._resultMaps.Contains(resultMap.Id) == true)
            {
        ...
        {
            get { return this._parameterMaps; }
        }
